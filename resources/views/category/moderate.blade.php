...
@section('content')
    <div class="nav-tabs-custom flat">
        ...
        {{ csrf_field() }}
        <input type="hidden" name="moderate" value="ok"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text("title_single[$locale]", old("title_single[$locale]")?old("title_single[$locale]"):"", ["class"=>"form-control", "required"=>"required", "placeholder"=>trans("rent.title_single")]) !!}
                            </div>
                        </div>
        ...
        <div class="box-footer">
            <div class="form-horizontal">
                ...
                <button id="save" class="btn btn-flat btn-primary">{{ trans('rent.moderate') }}</button>
                <button type="button" onclick="document.getElementById('delete-moderate').submit()" name="delete" class="btn btn-flat btn-danger">{{ trans('rent.delete') }}</button>
                <a href="/" class="btn btn-flat btn-default">{{ trans('rent.cancel') }}</a>
            </div>
        </div>
        <!-- /.tab-content -->
        {{ Form::close() }}
        {!! Form::open(array('route' => ['category.update', $category->id.(\request()->has('redirect')?"?redirect=".\request('redirect'):"")],'files'=>true, "id"=>"delete-moderate")) !!}
        {{ csrf_field() }}
