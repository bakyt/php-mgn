...
@section('content')
    <div class="row">
        <div class="col-md-12" @if(!request()->has('query')) style="display: none;" @endif>
            <form class="searching-group" id="search" action="{{ route('search') }}" style="line-height: 2.3em">
            ...
            <div class="box box-solid" style="display:inline-block;background: white; margin-bottom: 20px; padding: 5px 5px 5px 5px">
                <span class="btn btn-sm"><i class="fa fa-sliders"></i><span class="hidden-xs">&nbsp;&nbsp;{{ __('rent.filter') }}</span></span>
                    ...
                    <select name="type" title="{{ __('rent.type') }}" style="width:85px" class="btn select-filter btn-sm btn-default">
                ...
                <div class="box box-solid search-result-box">
                    <div class="box-body">
                        ...
                        <div class="media-footer">
                            <small class="pull-left"><i class="fa fa-map-marker"></i> {{ isset($item->content->address)?$item->content->address:__('rent.not_specified') }}</small>
                        </div>
