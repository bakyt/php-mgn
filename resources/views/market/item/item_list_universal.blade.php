...
@section('content')
    <div class="box nav-tabs-custom flat" id="filter">
        ...
        <ul class="nav nav-tabs">
            <li data-widget="collapse" class="header" style="padding:5px;font-size: 13pt"><i style="display: none" class="fa fa-search"></i><i class="fa fa-search"></i></li>
            <li onclick="$('#filter-body').css('display','block');$('#filter').removeClass('collapsed-box')" @if($category->type == 2 or $Market->is_sale) style="display: none" @endif class="@if($category->type == 1 or !$Market->is_sale) active @endif"><a href="#rent" data-toggle="tab" aria-expanded="true">{{ trans('rent.rent') }}</a></li>
            <li onclick="$('#filter-body').css('display','block');$('#filter').removeClass('collapsed-box')" @if($category->type == 1 or !$Market->is_sale) style="display: none" @endif class="@if($category->type == 2 or $Market->is_sale) active @endif"><a href="#sale" data-toggle="tab" aria-expanded="false">{{ trans('rent.sale') }}</a></li>
        ...
        <div class="tab-pane @if($category->type == 0 and !$Market->is_sale or !$Market->is_sale and $category->type == 1) active @endif" id="rent">
        ...
        <div class="tab-pane @if($category->type == 0 and $Market->is_sale or $Market->is_sale and $category->type == 2) active @endif" id="sale">
            <form action="" method="get" class="form-group">
